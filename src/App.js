...
class App extends Component {
  ...
  getFilteredprojectList = () => {
    ...
    const fileteredProject = projectsList.filter(
      eachProjct => eachProjct.category === activeId,
    )
    return fileteredProject
  }
  ...
  render() {
    const filteredProjectsList = this.getFilteredprojectList()
    const {activeId} = this.state
    return (
        ...
        <ul className="tabs-container">
          {tabsList.map(tabDetails => (
            <TabItem
              ...
              changeOnclicking={this.changeOnclicking}
